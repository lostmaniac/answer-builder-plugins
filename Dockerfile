...
RUN cd /work && CGO_ENABLED=0 ANSWER_MODULE=github.com/apache/incubator-answer@1.2.0 ./answer build --with github.com/apache/incubator-answer-plugins/cache-redis --with github.com/apache/incubator-answer-plugins/connector-google
